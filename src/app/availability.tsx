        ...
        <section className='w-full py-6 md:py-8'>
          <div className='container grid items-start gap-4 px-4 text-center md:px-6 lg:gap-6'>
            <div className="p-6 space-y-2">
              ...
              <Button variant='default' className="underline" onClick={() => navigate("/")}>Go back</Button>
            </div>
          </div>
        </section>
      </div>
        ...
        <section className='w-full py-6 md:py-8'>
          <div className='container items-start justify-start gap-4 px-4 text-left md:px-6 lg:gap-6'>
            <Alert severity="success">
              ...
              Reference:
                <Link href="https://docs.pega.com/bundle/pcore-pconnect/page/pcore-pconnect-public-apis/api/getpagedataasync-datapagename-context-parameters-options.html" target="_blank" underline="hover">
          ...
          <div className='container grid items-start gap-4 px-4 text-center md:px-6 lg:gap-6'>
            <div className="p-6 space-y-4">
              ...
              {state?.address && <p><strong>Your address:</strong> {state.address}</p>}

              {state?.error ? (
                <p className="text-red-600">{state.error}</p>
              ) : (
                <>
                  <p><strong>Our services are available in your area:</strong> {isAvailable ? "Yes ✅" : "No ❌"}</p>
            ...
            <div className='flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4'>
              <Button variant='default' onClick={() => navigate("/package")}>Shop Package</Button>
